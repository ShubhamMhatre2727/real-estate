...
const Banner = () => {
  return (
    <div className="px-8 flex flex-col sm:flex-col-reverse">
        ...
        <div className="flex flex-wrap justify-center gap-4 py-3 sm:py-16 mx-auto">
        <div className="p-6 w-80 bg-white shadow-md rounded-full grid place-content-center">
            <Image src="/Group 21.svg" alt="" width={260} height={100} />
        </div>
        <div className="p-3 w-80 bg-white shadow-md rounded-full grid place-content-center">
